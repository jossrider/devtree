...
export default function RegisterView() {
  ...
  const handleRegister = async (formdata: RegisterForm) => {
    try {
      ...
      toast.success(data, { style: { background: 'green' } })
      reset()
      navigate('/auth/login', { replace: true })
    } catch (error) {
      if (isAxiosError(error) && error.response) {
        toast.error(error.response.data.error, { style: { background: 'red' } })
      }
    }
  }
  return (
        ...
        <div className='grid grid-cols-1 space-y-3'>
          ...
          <input
            ...
            {...register('password', {
              ...
              minLength: { value: 6, message: 'El password debe ser de 6 o mas caracteres!!' },
            })}
          />
